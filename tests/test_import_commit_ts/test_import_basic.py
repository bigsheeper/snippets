"""
Test: Basic import with explicit commit (auto_commit=false).
Import → wait Uncommitted → commit → index → load → search/query.
"""
...
def test_import_basic():
    ...
    remote_path = generate_and_upload_parquet(NUM_ROWS, start_id=0, prefix="basic")
