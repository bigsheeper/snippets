...
def setup_replication_with_data():
    utils.ensure_secondary_b()
    utils.init_replication_a_to_b()
...
def test_restart_b_mid_promotion():
    ...
    time.sleep(2)
    cc.stop_cluster_b(); time.sleep(2); cc.start_cluster_b()
    # honor env FAILOVER_TIMEOUT (seconds), default 180
    import os
...
if __name__ == "__main__":
    # 直接运行：python test_restart_b_during_force_promote.py
